...
public class PacketHandler extends FMLIndexedMessageToMessageCodec<YABMMessage> {
    ...
    public PacketHandler() {
        ...
        addDiscriminator(0, YABMMessage.OpenGUIMessage.class);
    }

    @Override
    public void encodeInto(ChannelHandlerContext ctx, YABMMessage msg, ByteBuf target) throws Exception {
        msg.toBytes(target);
    }
