...
public class GuiBackpack extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj.drawString(this.inventoryBackpack.hasCustomInventoryName() ? this.inventoryBackpack.getInventoryName() : I18n.format(this.inventoryBackpack.getInventoryName()), 8, this.ySize - 96 + 2, 4210752);
    }
