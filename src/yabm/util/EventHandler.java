...
import yabm.client.render.VialHolderRenderer;
...
public class EventHandler {
    ...
    public void onPlayerRender(RenderPlayerEvent.Specials.Pre e) {
        for (int i = 0; i < e.entityPlayer.inventory.getSizeInventory(); i++) {
            ...
            if (e.entityPlayer.inventory.getStackInSlot(i) != null && e.entityPlayer.inventory.getStackInSlot(i).itemID == YABM.itemVialHolder.itemID) {
                e.renderCape = false;
